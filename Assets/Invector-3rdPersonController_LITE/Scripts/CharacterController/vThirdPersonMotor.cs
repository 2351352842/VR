...
namespace Invector.vCharacterController
{
    ...
    {
        public static vThirdPersonMotor instance;
        void Awake()
        {
            instance = this;
        }
        ...
        public vMovementSpeed freedSpeed, strafeSpeed, LevelSpeed;
        [Header("- Airborne")]
        ...
        public virtual void SetControllerMoveSpeed(vMovementSpeed speed)
        {
            if (speed.walkByDefault)
            {
                ...
                moveSpeed = Mathf.Lerp(moveSpeed, isSprinting ? speed.runningSpeed : PlayerInitialization.instance.player.speed, speed.movementSmooth * Time.deltaTime);
        ...
        {
            RotateToDirection(direction, isStrafing ? strafeSpeed.rotationSpeed : LevelSpeed.rotationSpeed);
        }
